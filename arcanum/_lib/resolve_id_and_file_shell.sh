#!/usr/bin/env bash
# Shell implementation of the "resolve-id-and-file" migrated entrypoint —
...
# a native implementation yet, via arcanum/_lib/resolve_id_and_file.sh's
# engine_dispatch shim — never called directly by skills.
#
# Resolve issue ID, title, and filename from skill arguments and issues
# folder.
# Usage: resolve_id_and_file_shell.sh <repo_path> <issues_folder> [arg_string]
#
