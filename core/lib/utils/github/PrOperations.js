...
import ConfigChain from '../config/ConfigChain.js';
 ...
 * which now delegates to this class as a thin facade.
 */
class PrOperations {
  /**
   ...
   *   used by `prNumber`'s/`prMerge`'s cache lookups.
   ...
   * `BranchCleanup#cleanupBranch`'s own tolerant remote-delete step.
   * @param {string} repo - the `owner/repo` path.
