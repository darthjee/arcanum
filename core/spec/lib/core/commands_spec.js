...
describe('COMMANDS', () => {
  ...
  it('sets context: \'repo\' on the migrated arcanum-split-issue, auto-fix-all lifecycle, auto-fix-issue-commit-change, auto-fix-issue-create-branch, auto-fix-issue-merge-main, auto-fix-all-github, auto-fix-issue-github, auto-monitor-issue-pr-resolve-pr-number, auto-monitor-pr-monitor-pr, auto-plan-issue-commit-plan, discuss-issue-render-issue, auto-fix-all-queue and spawn-issue entries', () => {
