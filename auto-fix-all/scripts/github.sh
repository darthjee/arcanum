...
#   cleanup-branch <branch> Delete the remote and local branch, switch back to main
...
case "${1:-}" in
  ...
  *)
    ...
    echo "  cleanup-branch <branch> Delete the remote and local branch, switch back to main" >&2
