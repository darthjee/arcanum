---
name: discuss-issue
description: Discusses and refines an existing GitHub issue through an iterative dialogue, optionally spawning specialist agents to deepen understanding, then saves a structured markdown issue file and, on confirmation, kicks off planning on a committed branch. Usage: /discuss-issue #19
---
